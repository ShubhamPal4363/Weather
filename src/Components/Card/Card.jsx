...
function Card() {
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col items-center justify-center" style={backgroundImage} >
        <h1 className="text-4xl font-semibold py-5 text-center">
          Weather Details
        </h1>

        <div className="flex flex-col bg-white rounded p-8 w-full max-w-xs shadow-lg">
          <div className="font-bold text-xl text-black">{Cvalue.location.name}</div>
          ...
          <div className="mt-6 self-center inline-flex items-center justify-center w-36 h-36">
            <img src={Cvalue.current.condition.icon} alt="weatherIcon" className="object-contain w-full h-full" />
          </div>
          <div className="flex flex-row items-center justify-center mt-6">
            <div className="font-medium text-6xl text-black">{Cvalue.current.temp_c}°</div>
            <div className="flex flex-col items-center ml-6">
              <div>
                <h1 className="text-2xl text-gray-400 font-semibold text-nowrap">{Cvalue.current.condition.text}</h1>
              </div>
              <div className="mt-1">
          ...
          <div className="flex flex-wrap justify-between mt-6 gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500">{Cvalue.current.pressure_mb} mb</div>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div>
              ...
              <div>
                ...
                <div className="text-sm text-gray-500">{Cvalue.current.vis_km} km</div>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div>
              ...
              <div>
                ...
                <div className="text-sm text-gray-500">{Cvalue.current.humidity} %</div>
              </div>
            </div>
          </div>
        </div>
